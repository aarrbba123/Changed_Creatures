package net.hhdsj.goodblock.client.models.other;
...
public class CrystalModel extends Model {
    public static final ResourceLocation TEXTURE = new ResourceLocation(GoodblockMod.MODID, "textures/entity/crystal/crystal.png");
