...
import net.hhdsj.changed_creatures.client.models.latex_dragon.ModelLatexDuskDawnDragon;
...
public class LatexDuskDawnDragonRenderer extends AdvancedHumanoidRenderer<LatexDuskDawnDragonEntity, ModelLatexDuskDawnDragon> {
	...
	ResourceLocation DrakTexture = new ResourceLocation("changed_creatures:textures/entities/latex/latex_dusk_dawn_dragon_black.png");
	ResourceLocation WhiteTexture = new ResourceLocation("changed_creatures:textures/entities/latex/latex_dusk_dawn_dragon_white.png");
