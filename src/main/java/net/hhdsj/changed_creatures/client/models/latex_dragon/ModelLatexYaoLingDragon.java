...
import net.hhdsj.changed_creatures.entity.simple.LatexYaoLingDragonEntity;
...
public class ModelLatexYaoLingDragon extends AdvancedHumanoidModel<LatexYaoLingDragonEntity>{
	...
	public static final ModelLayerLocation LAYER_LOCATION =
			ChangedCreature.ChangedCreatureModelResourceLocation("latex_yao_ling_dragon");
	...
	public final HumanoidAnimator<LatexYaoLingDragonEntity, ModelLatexYaoLingDragon> animator;

	public ModelLatexYaoLingDragon(ModelPart root) {
		super(root);
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 16).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F))
				.texOffs(16, 36).addBox(-2.0F, -3.0F, -6.0F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
		...
		PartDefinition right_ear_r1 = RightEar.addOrReplaceChild("right_ear_r1", CubeListBuilder.create().texOffs(64, 24).addBox(4.0F, -24.8F, -22.0F, 2.0F, 6.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(14, 70).addBox(4.0F, -26.0F, -25.0F, 2.0F, 8.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.8727F, -0.1309F, -0.2618F));

		PartDefinition LeftEar = Head.addOrReplaceChild("LeftEar", CubeListBuilder.create(), PartPose.offset(0.0F, 25.0F, 0.3F));

		PartDefinition left_ear_r1 = LeftEar.addOrReplaceChild("left_ear_r1", CubeListBuilder.create().texOffs(64, 49).mirror().addBox(-6.0F, -24.8F, -22.0F, 2.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(4, 67).addBox(-6.0F, -26.0F, -25.0F, 2.0F, 8.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.8727F, 0.1309F, 0.2618F));

		PartDefinition RightHorn = Head.addOrReplaceChild("RightHorn", CubeListBuilder.create(), PartPose.offset(0.0F, 25.1F, 0.0F));

		PartDefinition right_horn_r1 = RightHorn.addOrReplaceChild("right_horn_r1", CubeListBuilder.create().texOffs(66, 6).addBox(-3.0F, -28.15F, -20.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(66, 0).addBox(-3.0F, -30.5F, -21.0F, 2.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.6545F, -0.1745F, 0.0F));

		PartDefinition LeftHorn = Head.addOrReplaceChild("LeftHorn", CubeListBuilder.create(), PartPose.offset(0.0F, 25.1F, 0.0F));

		PartDefinition left_horn_r1 = LeftHorn.addOrReplaceChild("left_horn_r1", CubeListBuilder.create().texOffs(72, 6).addBox(1.0F, -28.15F, -20.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(60, 0).addBox(1.0F, -30.5F, -21.0F, 2.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.6545F, 0.1745F, 0.0F));
		...
		PartDefinition cube_r1 = leftWingRoot.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(32, 22).addBox(18.975F, -4.475F, 1.65F, 7.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.0F, 20.0F, -2.0F, 0.0F, 0.0F, -1.2654F));

		PartDefinition cube_r2 = leftWingRoot.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(61, 9).addBox(19.075F, -12.7F, 1.2F, 6.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.0F, 20.0F, -2.0F, 0.0F, 0.0F, -0.7854F));
		...
		PartDefinition cube_r4 = leftSecondaries.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(54, 66).addBox(-2.025F, -22.55F, 1.2F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-9.3F, 27.0F, -1.5F, 0.0F, 0.0F, 0.48F));

		PartDefinition cube_r5 = leftSecondaries.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(58, 37).addBox(15.525F, -13.85F, 1.648F, 9.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-9.3F, 27.0F, -1.5F, 0.0F, 0.0F, -0.7418F));

		PartDefinition cube_r6 = leftSecondaries.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(38, 57).addBox(13.4F, 10.625F, 1.651F, 9.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-9.3F, 27.0F, -1.5F, 0.0F, 0.0F, -1.8326F));
		...
		PartDefinition cube_r7 = leftTertiaries.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(0, 0).addBox(-3.3F, -22.5F, 1.2F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-9.0F, 27.0F, -1.5F, 0.0F, 0.0F, 0.5236F));

		PartDefinition cube_r8 = leftTertiaries.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(58, 16).addBox(16.125F, -10.525F, 1.649F, 9.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-9.0F, 27.0F, -1.5F, 0.0F, 0.0F, -0.8727F));
		...
		PartDefinition cube_r10 = rightWingRoot.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(37, 0).addBox(-25.975F, -4.475F, 1.65F, 7.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0F, 20.0F, -2.0F, 0.0F, 0.0F, 1.2654F));

		PartDefinition cube_r11 = rightWingRoot.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(60, 21).addBox(-25.075F, -12.7F, 1.2F, 6.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0F, 20.0F, -2.0F, 0.0F, 0.0F, 0.7854F));
		...
		PartDefinition cube_r13 = rightSecondaries.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(0, 67).addBox(1.025F, -22.55F, 1.2F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(9.3F, 27.0F, -1.5F, 0.0F, 0.0F, -0.48F));
		...
		PartDefinition cube_r15 = rightSecondaries.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(56, 57).addBox(-24.525F, -13.85F, 1.648F, 9.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(9.3F, 27.0F, -1.5F, 0.0F, 0.0F, 0.7418F));
		...
		PartDefinition cube_r16 = rightTertiaries.addOrReplaceChild("cube_r16", CubeListBuilder.create().texOffs(4, 16).addBox(2.3F, -22.5F, 1.2F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(9.0F, 27.0F, -1.5F, 0.0F, 0.0F, -0.5236F));
		...
		PartDefinition cube_r18 = rightTertiaries.addOrReplaceChild("cube_r18", CubeListBuilder.create().texOffs(53, 32).addBox(-25.125F, -10.525F, 1.649F, 9.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(9.0F, 27.0F, -1.5F, 0.0F, 0.0F, 0.8727F));
		...
		PartDefinition TailQuaternary = TailTertiary.addOrReplaceChild("TailQuaternary", CubeListBuilder.create(), PartPose.offsetAndRotation(0.75F, 0.5F, 4.5F, -0.0494F, -0.0493F, -0.7842F));

		PartDefinition Base_r1 = TailQuaternary.addOrReplaceChild("Base_r1", CubeListBuilder.create().texOffs(64, 43).addBox(-2.0F, -11.45F, 13.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(-0.05F)), PartPose.offsetAndRotation(0.0F, 10.0F, -12.75F, 0.0436F, 0.0F, 0.0F));
    ...
    public void setupHand(LatexYaoLingDragonEntity entity) {
        animator.setupHand();
    }
	...
	@Override
    public HumanoidAnimator<LatexYaoLingDragonEntity, ModelLatexYaoLingDragon> getAnimator(LatexYaoLingDragonEntity entity) {
        return this.animator;
    }

    public void setupAnim(@NotNull LatexYaoLingDragonEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
