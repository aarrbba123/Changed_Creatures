...
import net.hhdsj.changed_creatures.entity.simple.LatexEtanKindEntity;
...
public class ModelLatexEtanKind extends AdvancedHumanoidModel<LatexEtanKindEntity> {//implements AdvancedHumanoidModelInterface<LatexEtanKindEntity, ModelLatexOrangeFox> {//<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION =
			ChangedCreature.ChangedCreatureModelResourceLocation("latex_etan_kind.json");
	...
	public final HumanoidAnimator<LatexEtanKindEntity, ModelLatexEtanKind> animator;

	public ModelLatexEtanKind(ModelPart root) {
		super(root);
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition RightEarPivot = RightEar.addOrReplaceChild("RightEarPivot", CubeListBuilder.create().texOffs(58, 57).addBox(-2.9F, -3.5F, -1.0F, 4.0F, 7.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(32, 44).addBox(-3.9F, -1.5F, -1.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(0, 0).addBox(-2.3F, -2.15F, -0.3F, 3.0F, 5.0F, 1.0F, new CubeDeformation(0.04F))
				.texOffs(0, 22).addBox(-1.9F, -4.5F, -1.0F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(37, 0).addBox(-0.9F, -5.5F, -1.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition LeftEarPivot = LeftEar.addOrReplaceChild("LeftEarPivot", CubeListBuilder.create().texOffs(44, 44).addBox(2.9F, -1.5F, -1.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(0, 16).addBox(-0.7F, -2.15F, -0.3F, 3.0F, 5.0F, 1.0F, new CubeDeformation(0.04F))
				.texOffs(0, 6).addBox(-1.1F, -4.5F, -1.0F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(20, 36).addBox(-1.1F, -5.5F, -1.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(32, 22).addBox(-0.7F, -4.15F, -0.3F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.04F))
				.texOffs(48, 57).addBox(-1.1F, -3.5F, -1.0F, 4.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -2.85F, 0.3F, -0.2967F, -0.6109F, 0.4992F));
		...
		PartDefinition Base_r1 = TailPrimary.addOrReplaceChild("Base_r1", CubeListBuilder.create().texOffs(0, 56).addBox(-2.0F, 0.75F, -1.5F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 1.1781F, 0.0F, 0.0F));
	...
	public void setupHand(LatexEtanKindEntity entity) {
        animator.setupHand();
    }
    ...
    public ModelPart getTorso() {
	 ...
	 @Override
    public HumanoidAnimator<LatexEtanKindEntity, ModelLatexEtanKind> getAnimator(LatexEtanKindEntity entity) {
        return this.animator;
    }

    public void setupAnim(@NotNull LatexEtanKindEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
