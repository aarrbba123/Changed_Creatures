package net.hhdsj.changed_creatures.client.models.cat;

import com.mojang.blaze3d.vertex.PoseStack;
import com.mojang.blaze3d.vertex.VertexConsumer;
import net.hhdsj.changed_creatures.ChangedCreature;
import net.hhdsj.changed_creatures.entity.simple.LatexBlueveCatEntity;
...
public class ModelLatexBlueveCat extends AdvancedHumanoidModel<LatexBlueveCatEntity> {
    public static final ModelLayerLocation LAYER_LOCATION =
            ChangedCreature.ChangedCreatureModelResourceLocation("latex_blueve_cat");
    ...
    public final HumanoidAnimator<LatexBlueveCatEntity, ModelLatexBlueveCat> animator;


    public ModelLatexBlueveCat(ModelPart root) {
        super(root);
    ...
    @Override
    public HumanoidAnimator<LatexBlueveCatEntity, ModelLatexBlueveCat> getAnimator(LatexBlueveCatEntity entity) {
        return this.animator;
    }

    public void setupHand(LatexBlueveCatEntity entity) {
        animator.setupHand();
    }
    ...
    public void setupAnim(@NotNull LatexBlueveCatEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
