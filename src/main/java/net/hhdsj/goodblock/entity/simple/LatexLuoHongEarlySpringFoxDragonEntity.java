...
public class LatexLuoHongEarlySpringFoxDragonEntity extends ChangedEntity {
    ...
    public static void init() {
        SpawnPlacements.register(GoodblockModEntities.LATEXLUOHONGEARLYSPRINGFOXDRAGON.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
