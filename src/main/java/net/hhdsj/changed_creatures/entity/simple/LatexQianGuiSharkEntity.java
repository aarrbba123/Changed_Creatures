...
public class LatexQianGuiSharkEntity extends AbstractKitsuneEntity {
    @Override
    ...
    public LatexQianGuiSharkEntity(EntityType<? extends ChangedEntity> type, Level level) {
        super(type, level);
    }

    public LatexQianGuiSharkEntity(PlayMessages.SpawnEntity ignoredPacket, Level world) {
        this(ChangedCreatureModEntities.LATEX_QIAN_GUI_SHARK.get(), world);
    }
