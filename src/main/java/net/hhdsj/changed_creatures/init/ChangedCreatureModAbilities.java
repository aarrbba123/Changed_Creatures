...
import net.hhdsj.changed_creatures.abilities.*;
...
public class ChangedCreatureModAbilities {
    public static final DeferredRegister<AbstractAbility<?>> REGISTRY = ChangedRegistry.ABILITY.createDeferred(ChangedCreature.MODID);
    ...
    static {
        ...
        //创作火龙果
        CREATE_DRAGON_FRUIT = REGISTRY.register("create_dragon_fruit_ability", () -> new SimpleCreateItemAbility(() -> new ItemStack(ChangedCreatureModItems.DRAGONFRUIT.get()), 1.0f, 1.0f));
        //水晶箭
