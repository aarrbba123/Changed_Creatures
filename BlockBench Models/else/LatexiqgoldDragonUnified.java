...
public class LatexiqgoldDragonUnified<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "latexiqgolddragonunified"), "main");
	...
	public LatexiqgoldDragonUnified(ModelPart root) {
		...
		this.bone4 = this.Torso.getChild("bone4");
		this.RightArm = root.getChild("RightArm");
		this.bone3 = this.RightArm.getChild("bone3");
		this.hair2 = this.RightArm.getChild("hair2");
		this.LeftArm = root.getChild("LeftArm");
		this.hair3 = this.LeftArm.getChild("hair3");
	}
