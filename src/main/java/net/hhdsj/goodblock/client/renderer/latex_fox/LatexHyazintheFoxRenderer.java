...
import net.hhdsj.goodblock.client.model.latex_fox.ModelLatexHyazintheFox;
...
public class LatexHyazintheFoxRenderer extends
	...
	public LatexHyazintheFoxRenderer(EntityRendererProvider.Context context) {
		...
		this.addLayer(new EmissiveBodyLayer<>(this,
				new ResourceLocation("goodblock", "textures/entities/latex/latex_hyazinthe_fox_light.png")));
	...
	public ResourceLocation getTextureLocation(LatexHyazintheFoxEntity entity) {
		return new ResourceLocation("goodblock:textures/entities/latex/latex_hyazinthe_fox.png");
	}
}
