...
public class PaleTreeSpawnProcedure {
	...
	private static void generateTree(LevelAccessor world, double x, double y, double z) {
		BlockState woodLog = ChangedCreatureModBlocks.PALE_WOOD_LOG.get().defaultBlockState();
		BlockState leaves = ChangedCreatureModBlocks.PALE_WOOD_LEAVES.get().defaultBlockState();
