...
public class LatexthreemonthwolfEntity extends ChangedEntity implements RangedAttackMob {
	...
	public LatexthreemonthwolfEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChangedCreatureModEntities.LATEXTHREEMONTHWOLF.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(ChangedCreatureModEntities.LATEXTHREEMONTHWOLF.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
