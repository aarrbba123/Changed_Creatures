...
import net.hhdsj.goodblock.entity.simple.LatexSteppenWoldEntity;
...
@OnlyIn(Dist.CLIENT)
public class ModelLatexSteppenWolf extends AdvancedHumanoidModel<LatexSteppenWoldEntity>{
...
public final HumanoidAnimator <LatexSteppenWoldEntity, ModelLatexSteppenWolf> animator;
...
public ModelLatexSteppenWolf(ModelPart root) {
	...
	@Override
    public HumanoidAnimator<LatexSteppenWoldEntity, ModelLatexSteppenWolf> getAnimator(LatexSteppenWoldEntity entity) {
        return this.animator;
	}
	
    public void setupHand(LatexSteppenWoldEntity entity) {
        animator.setupHand();
    }
    ...
    public void setupAnim(@NotNull LatexSteppenWoldEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
