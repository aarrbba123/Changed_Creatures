...
public class ModelLuoHongEarlySpringFoxDragon extends AdvancedHumanoidModel<LatexLuoHongEarlySpringFoxDragonEntity>{//<T extends Entity> extends EntityModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r10 = hair.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(56, 41).addBox(-6.0F, 0.0F, -1.0F, 7.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.5F, 0.7929F, -3.2929F, -0.7854F, 0.0F, 0.0F));
		...
		PartDefinition cube_r11 = rightWingRoot.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(58, 62).addBox(-24.5444F, -4.0239F, 1.65F, 7.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0F, 20.0F, -2.0F, 0.0F, 0.0F, 1.2654F));

		PartDefinition cube_r12 = rightWingRoot.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(60, 23).addBox(-24.0143F, -11.6393F, 1.2F, 6.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0F, 20.0F, -2.0F, 0.0F, 0.0F, 0.7854F));

		PartDefinition cube_r13 = rightWingRoot.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(62, 67).addBox(-12.262F, -18.3405F, 1.2F, 5.0F, 2.0F, 1.0F, new CubeDeformation(-0.01F)), PartPose.offsetAndRotation(2.0F, 20.0F, -2.0F, 0.0F, 0.0F, 0.3491F));
		...
		PartDefinition cube_r14 = rightSecondaries.addOrReplaceChild("cube_r14", CubeListBuilder.create().texOffs(26, 65).addBox(-0.5F, 1.0F, -0.5F, 1.0F, 11.0F, 1.0F, new CubeDeformation(0.01F)), PartPose.offsetAndRotation(1.05F, 0.824F, 0.2F, 0.0F, 0.0F, 0.1745F));
		...
		PartDefinition cube_r16 = rightSecondaries.addOrReplaceChild("cube_r16", CubeListBuilder.create().texOffs(56, 33).addBox(-21.3393F, 9.5643F, 1.651F, 9.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(9.3F, 27.0F, -1.5F, 0.0F, 0.0F, 1.8326F));

		PartDefinition cube_r17 = rightSecondaries.addOrReplaceChild("cube_r17", CubeListBuilder.create().texOffs(42, 64).addBox(-0.5F, 2.0F, -0.5F, 1.0F, 11.0F, 1.0F, new CubeDeformation(0.01F)), PartPose.offsetAndRotation(1.25F, 0.724F, 0.2F, 0.0F, 0.0F, 0.5411F));

		PartDefinition cube_r18 = rightSecondaries.addOrReplaceChild("cube_r18", CubeListBuilder.create().texOffs(56, 27).addBox(-22.0944F, -13.3989F, 1.648F, 8.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(9.3F, 27.0F, -1.5F, 0.0F, 0.0F, 0.7418F));
		...
		PartDefinition cube_r19 = rightTertiaries.addOrReplaceChild("cube_r19", CubeListBuilder.create().texOffs(30, 70).addBox(-8.6514F, -26.1346F, 1.2F, 1.0F, 10.0F, 1.0F, new CubeDeformation(0.005F)), PartPose.offsetAndRotation(9.0F, 27.0F, -1.5F, 0.0F, 0.0F, 0.0436F));

		PartDefinition cube_r20 = rightTertiaries.addOrReplaceChild("cube_r20", CubeListBuilder.create().texOffs(0, 0).addBox(-24.0643F, -11.5857F, 1.64F, 9.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(9.0F, 27.0F, -1.5F, 0.0F, 0.0F, 0.8727F));
		...
		PartDefinition cube_r21 = leftWingRoot.addOrReplaceChild("cube_r21", CubeListBuilder.create().texOffs(0, 64).addBox(17.5444F, -4.0239F, 1.65F, 7.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.0F, 20.0F, -2.0F, 0.0F, 0.0F, -1.2654F));

		PartDefinition cube_r22 = leftWingRoot.addOrReplaceChild("cube_r22", CubeListBuilder.create().texOffs(64, 59).addBox(18.0143F, -11.6393F, 1.2F, 6.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.0F, 20.0F, -2.0F, 0.0F, 0.0F, -0.7854F));

		PartDefinition cube_r23 = leftWingRoot.addOrReplaceChild("cube_r23", CubeListBuilder.create().texOffs(0, 69).addBox(7.262F, -18.3405F, 1.2F, 5.0F, 2.0F, 1.0F, new CubeDeformation(-0.01F)), PartPose.offsetAndRotation(-2.0F, 20.0F, -2.0F, 0.0F, 0.0F, -0.3491F));
		...
		PartDefinition cube_r24 = leftSecondaries.addOrReplaceChild("cube_r24", CubeListBuilder.create().texOffs(14, 65).addBox(-0.5F, 2.0F, -0.5F, 1.0F, 11.0F, 1.0F, new CubeDeformation(0.01F)), PartPose.offsetAndRotation(-1.25F, 0.724F, 0.2F, 0.0F, 0.0F, -0.5411F));

		PartDefinition cube_r25 = leftSecondaries.addOrReplaceChild("cube_r25", CubeListBuilder.create().texOffs(58, 67).addBox(-0.5F, 1.0F, -0.5F, 1.0F, 11.0F, 1.0F, new CubeDeformation(0.01F)), PartPose.offsetAndRotation(-1.05F, 0.824F, 0.2F, 0.0F, 0.0F, -0.1745F));

		PartDefinition cube_r26 = leftSecondaries.addOrReplaceChild("cube_r26", CubeListBuilder.create().texOffs(20, 32).addBox(-0.5F, 0.0F, -0.5F, 1.0F, 12.0F, 1.0F, new CubeDeformation(0.01F)), PartPose.offsetAndRotation(-1.05F, 0.824F, 0.2F, 0.0F, 0.0F, 0.2094F));

		PartDefinition cube_r27 = leftSecondaries.addOrReplaceChild("cube_r27", CubeListBuilder.create().texOffs(0, 58).addBox(14.0944F, -13.3989F, 1.648F, 8.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-9.3F, 27.0F, -1.5F, 0.0F, 0.0F, -0.7418F));

		PartDefinition cube_r28 = leftSecondaries.addOrReplaceChild("cube_r28", CubeListBuilder.create().texOffs(56, 37).addBox(12.3393F, 9.5643F, 1.651F, 9.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-9.3F, 27.0F, -1.5F, 0.0F, 0.0F, -1.8326F));
		...
		PartDefinition cube_r29 = leftTertiaries.addOrReplaceChild("cube_r29", CubeListBuilder.create().texOffs(0, 0).addBox(15.0643F, -11.5857F, 1.64F, 9.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-9.0F, 27.0F, -1.5F, 0.0F, 0.0F, -0.8727F));

		PartDefinition cube_r30 = leftTertiaries.addOrReplaceChild("cube_r30", CubeListBuilder.create().texOffs(34, 70).addBox(7.6514F, -26.1346F, 1.2F, 1.0F, 10.0F, 1.0F, new CubeDeformation(0.005F)), PartPose.offsetAndRotation(-9.0F, 27.0F, -1.5F, 0.0F, 0.0F, -0.0436F));

		PartDefinition Tail = Torso.addOrReplaceChild("Tail", CubeListBuilder.create().texOffs(10, 74).addBox(-2.0F, -6.0F, 1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(74, 35).addBox(1.0F, -6.0F, 1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 10.5F, 0.0F));
		...
		PartDefinition cube_r31 = hair2.addOrReplaceChild("cube_r31", CubeListBuilder.create().texOffs(72, 12).addBox(-3.5F, -2.0F, -2.0F, 4.0F, 3.0F, 1.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(3.8F, 6.4F, 3.1F, -0.1047F, 0.0F, 0.0F));

		PartDefinition cube_r32 = hair2.addOrReplaceChild("cube_r32", CubeListBuilder.create().texOffs(72, 16).addBox(-3.5F, -2.0F, -2.0F, 4.0F, 3.0F, 1.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(3.8F, 6.0F, -0.2F, 0.1047F, 0.0F, 0.0F));

		PartDefinition cube_r33 = hair2.addOrReplaceChild("cube_r33", CubeListBuilder.create().texOffs(64, 45).addBox(-0.5F, -2.0F, -2.0F, 1.0F, 3.0F, 4.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(0.5F, 6.0F, 0.0F, 0.0F, 0.0F, -0.1047F));
		...
		PartDefinition cube_r34 = hair3.addOrReplaceChild("cube_r34", CubeListBuilder.create().texOffs(72, 26).addBox(-0.5F, -2.0F, -2.0F, 4.0F, 3.0F, 1.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(-3.8F, 6.0F, -0.2F, 0.1047F, 0.0F, 0.0F));

		PartDefinition cube_r35 = hair3.addOrReplaceChild("cube_r35", CubeListBuilder.create().texOffs(64, 52).addBox(-0.5F, -2.0F, -2.0F, 1.0F, 3.0F, 4.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(-0.5F, 6.0F, 0.0F, 0.0F, 0.0F, 0.1047F));

		PartDefinition cube_r36 = hair3.addOrReplaceChild("cube_r36", CubeListBuilder.create().texOffs(0, 72).addBox(-0.5F, -2.0F, -2.0F, 4.0F, 3.0F, 1.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(-3.8F, 6.4F, 3.1F, -0.1047F, 0.0F, 0.0F));
