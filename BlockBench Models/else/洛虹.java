...
public class 洛虹<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "洛虹"), "main");
	...
	public 洛虹(ModelPart root) {
		...
		this.bone9 = this.ear.getChild("bone9");
		this.bone8 = this.ear.getChild("bone8");
