...
package net.hhdsj.goodblock.client.renderer.latex_wolf_dragon;
...
import net.hhdsj.goodblock.entity.simple.LatexXuanJinWolfDragonEntity;
...
public class LatexXuanJinWolfDragonRenderer extends AdvancedHumanoidRenderer<LatexXuanJinWolfDragonEntity, ModelLatexXuanJinWolfDragon> {
	...
	ResourceLocation TextureEntity = new ResourceLocation("goodblock:textures/entities/latex/latex_xuan_jin_wolfdragon.png");
