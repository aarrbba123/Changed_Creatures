package net.hhdsj.goodblock.client.models.latex_pup;

import com.mojang.blaze3d.vertex.PoseStack;
import com.mojang.blaze3d.vertex.VertexConsumer;
import net.hhdsj.goodblock.GoodblockMod;
import net.hhdsj.goodblock.entity.simple.InksugerEntity;
...
public class ModelInksuger extends AdvancedHumanoidModel<InksugerEntity>{
    ...
    public static final ModelLayerLocation LAYER_LOCATION =
            GoodblockMod.GoodBlockModelResourceLocation( "whitepupunified");
