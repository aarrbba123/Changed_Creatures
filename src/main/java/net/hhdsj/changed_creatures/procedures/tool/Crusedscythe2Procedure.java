package net.hhdsj.changed_creatures.procedures.tool;
...
public class Crusedscythe2Procedure {
	public static boolean execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == ChangedCreatureModItems.CURSED_SCYTHE.get() && entity.isShiftKeyDown()) {
			//给自己伤害15,凋零
