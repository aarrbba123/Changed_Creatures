...
public class DarkPurpleLatexDragonEntity extends ChangedEntity {
	...
	public DarkPurpleLatexDragonEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChangedCreatureModEntities.LATEXDARKPURPLEDRAGON.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(ChangedCreatureModEntities.LATEXDARKPURPLEDRAGON.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
