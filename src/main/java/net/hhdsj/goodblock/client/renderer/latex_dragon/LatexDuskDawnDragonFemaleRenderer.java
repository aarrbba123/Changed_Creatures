...
import net.hhdsj.goodblock.client.models.latex_dragon.ModelLatexDuskDawnDragonFemale;
...
public class LatexDuskDawnDragonFemaleRenderer extends AdvancedHumanoidRenderer<LatexDuskDawnDragonFemaleEntity, ModelLatexDuskDawnDragonFemale> {
	...
	ResourceLocation DrakTexture = new ResourceLocation("goodblock:textures/entities/latex/latex_dusk_dawn_dragon_female_black.png");
	ResourceLocation WhiteTexture = new ResourceLocation("goodblock:textures/entities/latex/latex_dusk_dawn_dragon_female_white.png");
