...
public class LatexPeanutButter<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "latexpeanutbutter"), "main");
	...
	public LatexPeanutButter(ModelPart root) {
		...
		this.RightBone = this.RightPad.getChild("RightBone");
		...
		this.LeftBone = this.LeftPad.getChild("LeftBone");
