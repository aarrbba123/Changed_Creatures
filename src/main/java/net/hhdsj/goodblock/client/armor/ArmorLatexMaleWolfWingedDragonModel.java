package net.hhdsj.goodblock.client.armor;
...
import static net.ltxprogrammer.changed.client.renderer.model.armor.LatexHumanoidArmorModel.addUnifiedLegs;
    ...
    public ArmorLatexMaleWolfWingedDragonModel(ModelPart modelPart, ArmorModel model) {
        ...
        this.animator = HumanoidAnimator.of(this)
                ...
                .addPreset(AnimatorPresets.wingedDragonLike(
                        ...
                        this.Tail, java.util.List.of(tailPrimary, tailSecondary),
    ...
    public static LayerDefinition createArmorLayer(ArmorModel layer) {
        ...
        PartDefinition rightWingRoot = RightWing.addOrReplaceChild("rightWingRoot",
                CubeListBuilder.create()
                        .texOffs(25, 23)
                        .mirror()
                        .addBox(7.775F, -19.75F, 1.2F, 5.0F, 2.0F, 1.0F, layer.deformation),
                PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.3491F));
