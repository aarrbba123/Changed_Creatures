...
public class LatexFrostScaleDragonTaurEntity extends ChangedEntity implements LatexTaur<LatexFrostScaleDragonTaurEntity> {
    ...
    public static void init() {
        SpawnPlacements.register(GoodblockModEntities.LATEX_FROST_SCALE_DRAGON_TAUR.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
