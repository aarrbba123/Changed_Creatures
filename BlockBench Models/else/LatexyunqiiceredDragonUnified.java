...
public class LatexiceredDragonUnified<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "latexicereddragonunified"), "main");
	...
	public LatexiceredDragonUnified(ModelPart root) {
