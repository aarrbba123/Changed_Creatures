...
public class GoodblockModSounds {
	...
	public static final RegistryObject<SoundEvent> NO_STOP = REGISTRY.register("no_stop",
			() -> SoundEvent.createVariableRangeEvent(new ResourceLocation("goodblock", "no_stop")));
	...
	public static final RegistryObject<SoundEvent> ANIT_FURRY_MUSIC = REGISTRY.register("anit_furry_music",
			() -> SoundEvent.createVariableRangeEvent(new ResourceLocation("goodblock", "anit_furry_music")));
	...
	public static final RegistryObject<SoundEvent> FLUTEMUSICA_1RECORDS = REGISTRY.register("flutemusica_1records",
			() -> SoundEvent.createVariableRangeEvent(new ResourceLocation("goodblock", "flutemusica_1records")));
}
