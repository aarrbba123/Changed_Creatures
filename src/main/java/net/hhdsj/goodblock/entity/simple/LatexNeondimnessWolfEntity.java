...
public class LatexNeondimnessWolfEntity extends ChangedEntity {
    ...
    public LatexNeondimnessWolfEntity(PlayMessages.SpawnEntity packet, Level world) {
        this(GoodblockModEntities.LATEXNEONDIMNESSWOLF.get(), world);
    }
    ...
    public static void init() {
        SpawnPlacements.register(GoodblockModEntities.LATEXNEONDIMNESSWOLF.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
