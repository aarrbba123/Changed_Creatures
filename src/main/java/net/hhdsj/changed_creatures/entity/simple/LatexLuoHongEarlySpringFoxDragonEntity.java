...
public class LatexLuoHongEarlySpringFoxDragonEntity extends ChangedEntity {
    @Override
    ...
    public LatexLuoHongEarlySpringFoxDragonEntity(PlayMessages.SpawnEntity packet, Level world) {
        this(ChangedCreatureModEntities.LATEXLUOHONGEARLYSPRINGFOXDRAGON.get(), world);
    }

    public LatexLuoHongEarlySpringFoxDragonEntity(EntityType<LatexLuoHongEarlySpringFoxDragonEntity> type, Level world) {
        super(type, world);
        xpReward = 0;
        setNoAi(false);
    }
    ...
    public static void init() {
        SpawnPlacements.register(ChangedCreatureModEntities.LATEXLUOHONGEARLYSPRINGFOXDRAGON.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
