...
public class LatexYueXiFoxFemaleEntity extends AbstractKitsuneEntity {
    @Override
    ...
    public LatexYueXiFoxFemaleEntity(EntityType<? extends ChangedEntity> type, Level level) {
        super(type, level);
    }

    public LatexYueXiFoxFemaleEntity(PlayMessages.SpawnEntity ignoredPacket, Level world) {
        this(ChangedCreatureModEntities.LATEX_YUE_XI_FOX_FEMALE.get(), world);
    }
