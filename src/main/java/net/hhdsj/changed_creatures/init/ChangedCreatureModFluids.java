...
import net.hhdsj.changed_creatures.fluid.gas.LatexCrystalJellyGas;
...
public class ChangedCreatureModFluids {
	...
	static {
		REGISTRY_TYPES = DeferredRegister.create(ForgeRegistries.Keys.FLUID_TYPES, "changed_creatures");
		REGISTRY_FLUIDS = DeferredRegister.create(ForgeRegistries.FLUIDS, "changed_creatures");
