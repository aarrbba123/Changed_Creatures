...
import net.hhdsj.changed_creatures.entity.simple.LatexChengXiEntity;
...
public class ModelLatexChengXi extends AdvancedHumanoidModel<LatexChengXiEntity> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION =
            ChangedCreature.ChangedCreatureModelResourceLocation("latex_cheng_xi");
    ...
    public final HumanoidAnimator<LatexChengXiEntity, ModelLatexChengXi> animator;

    public ModelLatexChengXi(ModelPart root) {
        super(root);
    ...
    public void setupHand(LatexChengXiEntity entity) {
        animator.setupHand();
    }
    ...
    @Override
    public HumanoidAnimator<LatexChengXiEntity, ModelLatexChengXi> getAnimator(LatexChengXiEntity entity) {
        return this.animator;
    }

    public void setupAnim(@NotNull LatexChengXiEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
